    ...
    <div className='w-full'>
      <div className='w-screen h-[50vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>Keyphrase extraction using BERT as an sentence embedder</h2>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <h2>Overview</h2>
          <ul>
            <li>Keyphrases are words or short phrases that best describe a given input text document. The project uses BERT as a sentence embedder to better understand the context in a given sentence. The project makes use of cosine similarity to find the similarity between the document embedding and phrase embedding of each of the candidate phrases and rank them accordingly.</li>
          </ul>

          <a
            href='https://github.com/sudhanvarajesh/Keyphrase-Extraction-using-BERT-as-a-Sentence-Embedder'
            target='_blank'
            rel='noreferrer'
          >
